      ...
      builder: (context, progress, child) {
        return ValueListenableBuilder<int>(
          ...
          builder: (context, totalScreenshots, child) {
            if (totalScreenshots == 0) return const SizedBox.shrink();

            final percentage = (progress.processed / totalScreenshots * 100)
                .toStringAsFixed(1);
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                        value: progress.processed / totalScreenshots,
                        minHeight: 8,
                        backgroundColor:
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          '${progress.processed} of $totalScreenshots screenshots processed',
                          style: Theme.of(context).textTheme.bodyMedium,
                        ),
                        Text(
                          '${totalScreenshots - progress.processed} remaining',
                          style: Theme.of(context)
                              .textTheme
                              .bodyMedium
                              ?.copyWith(
